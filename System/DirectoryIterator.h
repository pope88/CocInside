#ifndef System_DirectoryIterator_INCLUDED
#define System_DirectoryIterator_INCLUDED
...
private:
	Path _path;
	File _file;
	priv::DirectoryIteratorImpl* _pImpl;
};
...
#endif // System_DirectoryIterator_INCLUDED
