...
/// \ingroup system
///
/// System::String is a utility string class defined mainly for
...
/// s = System::String("hello", locale);
/// \endcode
///
/// System::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to System::String whenever library
/// requires it.
///
/// Please note that library also defines a low-level, generic
/// interface for Unicode handling, see the System::Utf classes.
///
////////////////////////////////////////////////////////////
