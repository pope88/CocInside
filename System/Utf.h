...
public :
    ...
    /// specializations of the System::Utf<> template, and allow
...
public :
    ...
    /// of System::Utf<>, it is defined for convenience (it is used by
...
///
/// System::Utf is a low-level, generic interface for counting, iterating,
/// encoding and decoding Unicode characters and strings. It is able
/// to handle ANSI, wide, UTF-8, UTF-16 and UTF-32 encodings.
///
/// System::Utf<X> functions are all static, these classes are not meant to
/// be instanciated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li System::Utf<8> (typedef'd to System::Utf8)
/// \li System::Utf<16> (typedef'd to System::Utf16)
/// \li System::Utf<32> (typedef'd to System::Utf32)
///
////////////////////////////////////////////////////////////
